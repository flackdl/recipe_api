...
class JustTheRecipeSerializer(serializers.Serializer):
    ...
    rating_value = serializers.FloatField(source='ratings', required=False, allow_null=True)
    rating_count = serializers.IntegerField(source='ratings_count', required=False, allow_null=True)
